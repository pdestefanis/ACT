...
class AlertsController extends AppController {
	...
	function triggeredAlerts() {
		...
		foreach (array_keys($alerts) as $a) {	
			$stat = $this->Alert->Unit->Stat->find('all', array('conditions' => array('unit_id' => $alerts[$a]['Alert']['unit_id'], 'Stat.location_id' => $alerts[$a]['Alert']['location_id'])));
			$tmp[$a] = end($stat);	
