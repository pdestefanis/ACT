...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Kits Batch', true), array('action' => 'edit', $unitsBatch['UnitsBatch']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Kits Batch', true), array('action' => 'delete', $unitsBatch['UnitsBatch']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $unitsBatch['UnitsBatch']['id'])); ?> </li>
