<div class="search">
	...
	<table cellpadding="0" cellspacing="0" class="norow">
		<tr>
			<th><?php echo __("Facility", true);?>
			</th>
			<th><?php echo __("Level", true);?>
			</th>
			<th><?php echo __("Counts", true);?>
			</th>
		</tr>
		...
		<tr <?php echo $class;?>>
			...
			<td>
				<table cellpadding="0" cellspacing="0" class="norow">
					<tr>
						<th><?php echo __("Kits", true);?>
						</th>
						<th><?php echo __("Aggregated", true);?>
						</th>
						<th><?php echo __("At Facility", true);?>
						</th>
						<th><?php echo __("Total", true);?>
						</th>
					</tr>
					<tr>
						<td><?php
						echo __("Current Stock", true); ?>&nbsp;</td>
						<td class='number'><?php echo $r['agg']['Assigned']; ?>&nbsp;</td>
						<td class='number'><?php echo $r['Assigned']; ?>&nbsp;</td>
						<td class='number'><?php echo $r['Total']['Assigned']; ?>&nbsp;</td>
					</tr>
					<tr>
						<td><?php
					...
					<tr>
						...
						<td class='number'><?php echo $r['Total']['Expired']; ?>&nbsp;</td>
					</tr>
				</table>
			</td>
		</tr>
