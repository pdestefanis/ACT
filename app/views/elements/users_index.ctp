...
<h2><?php __('Users');?></h2>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort(__('Full Name', true), 'name');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $access->checkHtml('Users/view', 'text', $user['User']['modified'], '/users/view/' . $user['User']['id'] ); ?>
		</td>
...
<div class="actions">
	...
	<ul>
		<li><?php 
		$access->checkHtml('Users/add', 'link', __('New User', true),'add/'  ); ?></li>
	</ul>
</div>
