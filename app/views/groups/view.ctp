<?php
	echo $crumb->getHtml('View Group', null, 'auto') ;
	echo '<br /><br />';
?>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				...
				<?php echo $this->Html->link(__('Delete', true), array('controller' => 'users', 'action' => 'delete', $user['id']), null, sprintf(__('Are you sure you want to delete %s?', true), $user['username'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
